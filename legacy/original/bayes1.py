...
def analysis():
    ...
    df.to_csv(f'bayes1_tap_{serial_num}.csv')
    
    df = pd.DataFrame({'Player_SE': player_SE, 'Stim_SE' : stim_SE})
    df.to_csv(f'bayes1_SE_{serial_num}.csv')
    
    df = pd.DataFrame({'Hypothesis': hypo})
    df.to_csv(f'bayes1_hypo_{serial_num}.csv')
    ...
    plt.savefig(f"bayes1_ITI_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    ...
    plt.legend(loc = 'upper left', fontsize = '13')
    plt.savefig(f"bayes1_ITIv_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    ...
    plt.legend(loc = 'upper left', fontsize = '13')
    plt.savefig(f"bayes1_SE_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    ...
    plt.legend(loc = 'upper left', fontsize = '13')
    plt.savefig(f"bayes1_SEv_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    
    #stim,playerのITIのヒストグラム
    plt.xlabel("ITI", fontsize = 20)
    ...
    plt.legend(loc = 'upper left', fontsize = '13')
    plt.savefig(f"bayes1_ITI_hist_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    ...
    f'R2 = {r2:.3f}'])
    plt.savefig(f"bayes1_stim_SE_ITI_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    ...
    f'R2 = {r2:.3f}'])
    plt.savefig(f"bayes1_stim_SE_ITIv_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    ...
    f'R2 = {r2:.3f}'])
    plt.savefig(f"bayes1_stim_SEv_ITI_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    ...
    f'R2 = {r2:.3f}'])
    plt.savefig(f"bayes1_stim_SEv_ITIv_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    ...
    f'R2 = {r2:.3f}'])
    plt.savefig(f"bayes1_player_SE_ITI_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    ...
    f'R2 = {r2:.3f}'])
    plt.savefig(f"bayes1_player_SE_ITIv_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    ...
    f'R2 = {r2:.3f}'])
    plt.savefig(f"bayes1_player_SEv_ITI_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
    ...
    f'R2 = {r2:.3f}'])
    plt.savefig(f"bayes1_player_SEv_ITIv_{serial_num}.pdf", bbox_inches = 'tight')
    plt.show()
...
while True:
    ...
    if flag == 0:
        ...
        if 'space' in keys:
            ...
            #タイマーの作成
            random_second = ((span / 2) - b1.inference(stim_SE[turn]))
